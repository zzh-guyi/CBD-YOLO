...
from ultralytics.nn.KAN import FastKANConv
from ultralytics.nn.WTConv2d import WTConv2d
from ultralytics.nn.SegAD import SegAD
from ultralytics.nn.MV4 import mobilenetv4_conv_small
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            CARAFE,
            Bottleneck,
            GhostBottleneck,MBConv,FusedMBConv,stem,
            SPP,
            SPPF,
            ...
            BoTNet,
            C3,
            MobileOneBlock,MobileViT,
            MobileViTBlock,MV2Block,
            ContextAggregation,
            DualConv,SwinTransformer,
            SPPELAN,HorBlock,
            EMA_attention,
            CondConv2D,
            AKConv,C2f_Faster,C3_Faster,
            C3TR,RepViTblock,
            C3Ghost,
            nn.ConvTranspose2d,
            DWConvTranspose2d,
            C3x,
            RepC3,
            PSA,VoVGSCSP, VoVGSCSPC,GSConv,
            SEAttention,
            ADown,WTConv2d,
            CAFMAttention,
            AConv,MSFN,MDCR,PPA,DASI,
            SCDown,C3KAN,
            Involution, 
            LightConv,
            CBAM,C2fAFF,
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, BoTNet,C3x, RepC3, C2fCIB):
