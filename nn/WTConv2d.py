...
class WTConv2d(nn.Module):
    def __init__(self, in_channels=128, out_channels=256, kernel_size=5, stride=1, bias=True, wt_levels=1, wt_type='db1'):
        ...
        self.base_conv = nn.Conv2d(in_channels, in_channels, kernel_size, padding=1, stride=1, dilation=1, groups=in_channels, bias=bias)
